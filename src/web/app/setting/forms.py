...
class PolicyForm(Form):
    name = StringField('外设策略名称', validators=[data_required(), length(1, 64)])
    enable_usb = BooleanField('启用USB')
    enable_clipboard = BooleanField('启用剪切板')
    enable_audio = BooleanField('启用音频')
