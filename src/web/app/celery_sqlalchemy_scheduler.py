# -*- coding: utf-8 -*-
#
# A celery scheduler with sqlalchemy support.
#
# Scheduler entries could be loaded from sqlalchemy database at runtime. This
# feature fulfill the requirement of pragmatically add / modify / delete tasks
# in celery beat process.
#
# NOTE: Original code is from https://github.com/tuomur/celery_sqlalchemy_scheduler
#
# 2016/2/16 fengyc :  Support flask-sqlalchemy
...
from .celery_sqlalchmey_scheduler_models import DatabaseSchedulerEntry, \
...
class DatabaseScheduler(Scheduler):
    ...
    def _all_as_schedule(self):
        ...
        for row in query:
            ...
            # TODO remove me
            print('*** Task %s ***' % row.name)
        # TODO remove me
        print('*** Find %s tasks ***' % len(s))
        return s
