# -*- coding: utf-8 -*-
#
# Models of celery sqlalchemy scheduler.
#
# Each table of model should be named with prefix 'celery_'.
#
...
# TODO Should add a 'onupdate' to DatabaseSchedulerEntry.data_changed and remove this function
